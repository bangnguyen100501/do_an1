...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Thanh trượt được cập nhật thành công!';
	}
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Vị trí </label>
							<div class="col-sm-6">
								<select name="position" class="form-control">
									<option value="Left" <?php if($position == 'Left') {echo 'selected';} ?>>Bên trái</option>
									<option value="Center" <?php if($position == 'Center') {echo 'selected';} ?>>Giữa</option>
									<option value="Right" <?php if($position == 'Right') {echo 'selected';} ?>>Bên phải</option>
								</select>
							</div>
						</div>
						<div class="form-group">
