...
if(isset($_POST['form1'])) {
    ...
    $error_message .= '\nSố lượng các mặt hàng được cập nhật thành công!';
    ?>

    <?php if($allow_update == 0): ?>
    	<script>alert('<?php echo $error_message; ?>');</script>
	<?php else: ?>
		<script>alert('Tất cả các mặt hàng cập nhật số lượng thành công!');</script>
	<?php endif; ?>
    <?php
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" class="input-text qty text" step="1" min="1" max="" name="quantity[]" value="<?php echo $arr_cart_p_qty[$i]; ?>" title="Số lượng" size="4" pattern="[0-9]*" inputmode="numeric">
                            </td>
                            <td class="text-right">
                                <?php
