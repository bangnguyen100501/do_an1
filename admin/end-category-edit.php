...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn DANH MỤC PHÂN LOẠI CÁC SẢN PHẨM<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục DANH MỤC CÁC SẢN PHẨM được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa DANH MỤC CÁC SẢN PHẨM</h1>
	</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="tcat_id" class="form-control select2 top-cat">
                            ...
                            foreach ($result as $row) {
                                ?>
                                <option value="<?php echo $row['tcat_id']; ?>" <?php if($row['tcat_id'] == $tcat_id){echo 'đã chọn';} ?>><?php echo $row['tcat_name']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="mcat_id" class="form-control select2 mid-cat">
                            ...
                            foreach ($result as $row) {
                                ?>
                                <option value="<?php echo $row['mcat_id']; ?>" <?php if($row['mcat_id'] == $mcat_id){echo 'đã chọn';} ?>><?php echo $row['mcat_name']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
