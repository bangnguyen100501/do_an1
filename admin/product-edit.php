				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên loại cấp cao nhất <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
		                            <option value="">Chọn danh mục cấp độ trung bình</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên loại cấp cuối <span>*</span></label>
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
		                            <option value="">Chọn loại cấp độ kết thúc</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh nổi bật hiện có</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="p_is_featured" class="form-control" style="width:auto;">
									...
									<option value="1" <?php if($p_is_featured == '1'){echo 'selected';} ?>>Đúng</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="p_is_active" class="form-control" style="width:auto;">
									...
									<option value="1" <?php if($p_is_active == '1'){echo 'selected';} ?>>Đúng</option>
								</select>
							</div>
						</div>
						<div class="form-group">
