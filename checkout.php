                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Bạn phải điền vào tất cả các thông tin thanh toán và giao hàng từ bảng điều khiển của bạn để kiểm tra đơn đặt hàng. Vui lòng điền thông tin vào <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">this link</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Ngân hàng"><?php echo LANG_VALUE_38; ?></option>
	                                    </select>
	                                </div>

                                    <form class="paypal" action="payment/bank/init2.php" method="post" id="paypal_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="hidden" name="transaction_info" value="Tiền mặt">
                                        </div>
                                    </form>
