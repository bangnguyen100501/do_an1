...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Đã thêm thành công chi phí vận chuyển.';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Đã cập nhật thành công chi phí vận chuyển.';
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: Nếu một tỉnh thành không tồn tại trong danh sách trên, chi phí vận chuyển sau đây sẽ được áp dụng.</h4>
