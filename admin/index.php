...
$statement->execute(array('Hoàn thành'));
	...
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">Danh mục phân loại các sản phẩm</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Danh mục các loại sản phẩm</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Danh mục các sản phẩm</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Tổng các sản phẩm</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				<span class="info-box-icon bg-green"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Đã hoàn thành giao hàng</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text">Đơn đặt hàng đang chờ</span>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				<span class="info-box-icon bg-red"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Đang chờ giao hàng (Đặt hàng thành công)</span>
