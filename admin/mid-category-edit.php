...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục CÁC LOẠI SẢN PHẨM<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục CÁC LOẠI SẢN PHẨM đã được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa danh mục CÁC LOẠI SẢN PHẨM</h1>
	</div>
