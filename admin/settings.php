...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Cài đặt Home Meta được cập nhật thành công.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Tìm hiểu thêm Không được để trống Văn bản<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'Tìm hiểu thêm URL không được để trống<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Dữ liệu được cập nhật thành công.';
...
if(isset($_POST['form6_4'])) {
    ...
    if(empty($_POST['featured_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Không được để trống Trang phụ Sản phẩm Nổi bật<br>';
    }
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Không được để trống SubTitle Sản phẩm Phổ biến<br>';
    }
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Bản tin Văn bản được cập nhật thành công.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Biểu ngữ Trang Đăng ký được cập nhật thành công.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Biểu ngữ trang đặt lại mật khẩu được cập nhật thành công.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Biểu ngữ trang thanh toán đã được cập nhật thành công.';
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Head và Body Script được cập nhật thành công.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_7" data-toggle="tab">Cài đặt biểu ngữ</a></li>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Biểu ngữ trang đăng ký hiện có</h4>
                                        <p>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Thay đổi biểu ngữ trang quên mật khẩu</h4>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Thay đổi Đặt lại Biểu ngữ Trang đặt lại Mật khẩu</h4>
                                        Chọn ảnh<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Biểu ngữ trang thanh toán hiện có</h4>
                                        <p>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Biểu ngữ trang danh mục sản phẩm hiện tại</h4>
                                        <p>
