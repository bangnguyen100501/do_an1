...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục CÁC LOẠI SẢN PHẨM không được để trống<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục CÁC LOẠI SẢN PHẨM đã được thêm thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Thêm danh mục cấp trung bình</h1>
	</div>
