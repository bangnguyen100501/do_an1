...
<section class="content-header">
	<div class="content-header-left">
		<h1>Xem danh mục CÁC LOẠI SẢN PHẨM</h1>
	</div>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
			<thead>
			    <tr>
			        <th>SL</th>
			        <th>Tên danh mục CÁC LOẠI SẢN PHẨM</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Hãy cẩn thận! Tất cả các sản phẩm và danh mục CÁC SẢN PHẨM trong danh mục CÁC LOẠI SẢN PHẨM này sẽ bị xóa khỏi tất cả các bảng như bảng đơn hàng, bảng thanh toán, bảng kích thước, bảng màu, bảng xếp hạng, v.v..</p>
            </div>
